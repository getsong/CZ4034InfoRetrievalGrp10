...
driver = webdriver.Chrome("C:/users/Pan/Downloads/chromedriver.exe")
...
#             }
#
# lp_list = [2717,2675,2665,2698,2581] # refer to below index, put suitable index list in
...
#     str6 = type_list["business"]  # need to change with different categories
#     str7 = "%2Cn%3A"
#     str8 = str(j)
#     str9 = "&page="
#     # need str9 for page
